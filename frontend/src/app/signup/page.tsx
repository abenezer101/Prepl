...
const testimonials = [
  {
    quote: "From zero interview experience to landing a senior role at Stripe in 3 weeks. Prepl's AI coaching is unlike anything else out there.",
    author: "David Park",
    role: "Senior Engineer at Stripe"
  },
  {
    quote: "The structured feedback after each mock session pinpointed exactly where my answers were weak. I walked into every interview with real confidence.",
    author: "Priya Sharma",
    role: "Product Manager at Notion"
  },
  {
    quote: "The WPM coach alone was worth it — I had no idea how fast I was speaking until Prepl showed me the data.",
    author: "James Okafor",
  ...
  return (
    <div className="h-screen w-full bg-[#fbf8f3] flex flex-col lg:flex-row relative overflow-hidden text-zinc-900 selection:bg-stone-300/40 font-sans">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none bg-[#fbf8f3]">
        ...
        />
        <div className="absolute top-[20%] left-[10%] w-[350px] h-[350px] bg-gradient-to-r from-amber-200/30 to-amber-100/20 rounded-full filter blur-[80px]" />
        <div className="absolute bottom-[20%] left-[30%] w-[450px] h-[450px] bg-gradient-to-r from-zinc-200/50 to-amber-50/20 rounded-full filter blur-[100px]" />
      </div>
      ...
      <div className="hidden lg:flex w-1/2 h-full max-h-screen relative z-10 flex-col justify-between pt-8 pb-4 px-8 xl:pt-12 xl:pb-6 xl:px-12 bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-950 text-white overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-40">
          <div className="absolute -top-[10%] -right-[10%] w-[60%] h-[60%] bg-gradient-to-bl from-amber-500/10 via-amber-600/5 to-transparent rounded-full filter blur-[60px]" />
          <div className="absolute -bottom-[10%] -left-[10%] w-[80%] h-[80%] bg-gradient-to-tr from-zinc-800/20 via-zinc-900/10 to-transparent rounded-full filter blur-[80px]" />
        </div>
      ...
      <div className="w-full lg:w-1/2 h-full max-h-screen relative z-10 flex items-center justify-center p-4 sm:p-8 overflow-hidden">
        ...
        >
          ...
          <div className="w-full bg-white/40 border border-white/50 backdrop-blur-xl rounded-3xl p-6 sm:p-8 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.03)] border-zinc-200/30">
            ...
            <div className="mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 mb-1">Create your account</h1>
              <p className="text-zinc-500 text-xs sm:text-sm">Start your AI-powered interview prep journey today.</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-center text-xs text-zinc-400 pt-1">
                Secure sign-up powered by Google OAuth
              </p>
            </div>
