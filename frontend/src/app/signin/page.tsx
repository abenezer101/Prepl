      ...
      <div className="hidden lg:flex w-1/2 relative z-10 flex-col justify-between p-12 border-r border-zinc-200">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-3xl font-bold tracking-tight leading-[1.1]">
            Practice. Improve. <br />
            <span className="text-zinc-500">Get hired.</span>
          </h2>
          <p className="text-zinc-600 text-base max-w-md leading-relaxed">
            Prepl runs realistic mock interviews, analyzes your communication pacing and tone, and gives you actionable feedback.
          </p>
          <div className="flex items-center gap-3 text-sm text-zinc-500">
            <Sparkles className="w-4 h-4 text-zinc-700" />
            <span>Interactive AI-powered preparation</span>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 relative z-10 flex items-center justify-center p-6 sm:p-8">
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-zinc-500 text-sm sm:text-base">Enter your details to access your workspace.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative flex items-center">
              ...
              <span className="flex-shrink-0 mx-3 text-zinc-400 text-xs">or sign in with email</span>
              <div className="flex-grow border-t border-zinc-200"></div>
            </div>
          ...
          <p className="mt-4 text-center text-sm text-zinc-500">
            ...
            <Link href="/signup" className="text-zinc-900 font-medium hover:text-zinc-700 transition-colors">
              Create one
            </Link>
          </p>
